...
class PremiumRingtonesRepository (val apiService: ApiService) {
    val premiumRingtonesResultFromAPI: MutableLiveData<MutableList<AllRingtonesResponseModel>> by lazy {
    ...
    fun getPremiumAllRingtones(): MutableLiveData<MutableList<AllRingtonesResponseModel>> {
        apiService.allRingtones().enqueue(object :
            ...
            override fun onResponse(
                ...
                premiumRingtonesResultFromAPI.postValue(response.body())
            }
        ...
        return premiumRingtonesResultFromAPI
    }
}